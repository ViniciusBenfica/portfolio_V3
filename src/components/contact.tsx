...
export default function Contact() {
	return (
		<section className="py-20 bg-[#0f1624] relative text-white">
			<div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
				<div className="max-w-5xl mx-auto">
					<div className="text-center mb-16">
						...
						<p className="text-lg text-[#c2c4c7] max-w-3xl mx-auto mt-6">
							Let's work together? Contact me through the form or my social media
						</p>
					</div>
							...
							<div className="bg-[#1b222f] border border-white/10 overflow-hidden rounded-lg relative">
								<div className="p-8">
									...
									<form className="space-y-4">
										...
										<button
											type="submit"
											className="w-full h-10 text-sm font-semibold rounded-md bg-gradient-to-r from-[#02c6ea] via-[#348df4] to-[#6A3DE8] hover:opacity-90"
										>
											Send Message
										</button>
									</form>
